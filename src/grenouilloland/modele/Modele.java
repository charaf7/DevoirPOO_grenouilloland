...
public class Modele {
	...
	public Nenuphar RandomNenuphar(int ligne, int colonne) {
		...
		case 1: return new NenupharNormal(ligne, colonne, EtatNenuphar.Grand);
		case 2: return new NenupharDopant(ligne, colonne, EtatNenuphar.Grand);
		case 3: return new NenupharMortel(ligne, colonne, EtatNenuphar.Grand);
		case 4: return new NenupharVeneneux(ligne, colonne, EtatNenuphar.Grand);
		case 5: return new NenupharNutritif(ligne, colonne, EtatNenuphar.Grand);
		default : return new NenupharNormal(ligne, colonne, EtatNenuphar.Grand);
	...
	public int getVies() {return grenouille.getVies();}
	public boolean IsGrenouilleMalade() {return grenouille.getMalade();	}
